                ...
                <tr><th colspan='6'>
                    ...
                    <a class='ui button orange dropdown floated icon right'><i class='icon filter'></i>
                      <div class='menu'>
                        ...
                        <div class='item'>Nearing Out Of Stock Products</div>
                      </div>
                    </a>
                </th></tr>
                <tr><th class='two wide'>Product Id</th><th class='five wide'>Name</th><th>Type</th><th>Price</th><th>Stock</th><th class='three wide'>Actions</th></tr>
              </thead>
              <tbody>
                <tr><td>SKU-12ID</td><td>Product #1</td><td>Default</td><td>&pound;12.99</td><td>112</td><td><a class='ui button icon green'><i class='icon edit'></i></a><a class='ui button icon primary'><i class='icon cube'></i></a> <a class='ui button icon red'><i class='icon delete'></i></a></td></tr>
                <tr><td>SKU-12ID</td><td>Product #1</td><td>Default</td><td>&pound;12.99</td><td>112</td><td><a class='ui button icon green'><i class='icon edit'></i></a><a class='ui button icon primary'><i class='icon cube'></i></a> <a class='ui button icon red'><i class='icon delete'></i></a></td></tr>
                <tr><td>SKU-12ID</td><td>Product #1</td><td>Default</td><td>&pound;12.99</td><td>112</td><td><a class='ui button icon green'><i class='icon edit'></i></a><a class='ui button icon primary'><i class='icon cube'></i></a> <a class='ui button icon red'><i class='icon delete'></i></a></td></tr>
                <tr><td>SKU-12ID</td><td>Product #1</td><td>Default</td><td>&pound;12.99</td><td>112</td><td><a class='ui button icon green'><i class='icon edit'></i></a><a class='ui button icon primary'><i class='icon cube'></i></a> <a class='ui button icon red'><i class='icon delete'></i></a></td></tr>
                <tr><td>SKU-12ID</td><td>Product #1</td><td>Default</td><td>&pound;12.99</td><td>112</td><td><a class='ui button icon green'><i class='icon edit'></i></a><a class='ui button icon primary'><i class='icon cube'></i></a> <a class='ui button icon red'><i class='icon delete'></i></a></td></tr>
